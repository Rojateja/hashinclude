...
# Task 3: Visualize the Rolling Average using Bar Plot
plt.figure(figsize=(12, 6))

# Bar plot for weekly confirmed cases
plt.bar(weekly_data.index, weekly_data['Confirmed'], label='Weekly Confirmed Cases', color='blue', alpha=0.5)
